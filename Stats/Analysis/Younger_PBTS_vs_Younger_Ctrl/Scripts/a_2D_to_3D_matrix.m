...
%Generates Younger PBTS vs Younger HC Data matrix only
...
catmatrix14 = [];
catmatrix15 = [];
for i = [7,8,12,14,15,16,17,18,19,21,22,24,25,26,30,32,33,34,35,37,39,40,41,42,47,50,51,54,55,57,60,61,66,67,68,69,71,72,73,74]
    try
