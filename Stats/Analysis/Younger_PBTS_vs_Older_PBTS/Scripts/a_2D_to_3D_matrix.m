...
%Generates Younger PBTS vs Older PBTS Data matrix only
...
catmatrix14 = [];
catmatrix15 = [];
for i = [3,6,7,8,9,10,12,13,14,17,18,21,22,24,25,29,30,31,34,45,46,47,50,51,52,53,56,59,60,61,63,64,66,69,70,71,72,74,75,76]
    try
